...
{
public:
	static IndexedTriangleList MakeTesselatedTextured( Vertex::Layout layout,int divisions_x,int divisions_y )
	{
		...
		indices.reserve( math_tool::square( divisions_x * divisions_y ) * 6 );
		{
	...
	{
		Vertex::Layout vl;
		vl.Append( Vertex::Position3D );
		vl.Append( Vertex::Normal );
		vl.Append( Vertex::Tex2D );
